                ...
                <div class="mt-2 max-w-auto mx-auto card p-4 bg-white rounded-b-lg shadow-md">
                    <div class="grid grid-cols-1 gap-6">
                        <form action="{{route('storeSection')}}" method="post">
                            @csrf
                            <label class="block">
                                <span class="text-gray-700">{{ __('quiz_dash.Quiz Name')  }}</span>
                                @error('section.name')
                            ...
                            <label class="block">
                                <span class="text-gray-700">{{ __('quiz_dash.Quiz Description')  }} Description</span>
                            ...
                            <label class="block">
                                <span class="text-gray-700">{{ __('quiz_dash.Quiz details') }}</span>
