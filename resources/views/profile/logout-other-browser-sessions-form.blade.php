<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('profile.manage_and_log_out_your_active_sessions_on_other_browsers_and_devices') }}
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('profile.if_necessary_you_may_log_out') }}
        </div>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('profile.please_enter_your_password_to_confirm_log_out') }}
